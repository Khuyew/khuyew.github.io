// Service Worker for KHAI - Первый белорусский чат с ИИ
...
self.addEventListener('install', (event) => {
    console.log('Service Worker: Installing KHAI...');
...
self.addEventListener('activate', (event) => {
    console.log('Service Worker: Activating KHAI...');
...
self.addEventListener('fetch', (event) => {
    ...
    if (url.origin !== self.location.origin && 
        ...
        !url.href.includes('js.puter.com')) {
        return;
    }
